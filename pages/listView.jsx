...
const listView = () => {
  ...
  const[upVoteCount,setUpvoteCount]=useState(20);
  const changeYours = () => {
            ...
            >
              <div className="profileCardUpperSection flex justify-around">
                ...
                <div className="upVoteCount bg-[#01002a] text-[#fff] rounded-full text-center w-[25%] sm:w-[20%] flex-col sm:text-2xl">
                  <TbTriangleFilled className="text-[#e40e82] m-auto" onClick={incUpVote} />
                  <h3 className="" >{upVoteCount}</h3>
                  <TbTriangleInvertedFilled className="m-auto" onClick={decUpVote} />
                </div>
              </div>
                  ...
                  <div className="skills  bg-[#01002A] p-5 mt-2 rounded-[1rem] sm:w-[45%]">
                    ...
                    <div className="mt-[1rem] grid grid-cols-2 sm:grid-cols-1 gap-4 text-[#fff]">
                      ...
                      {item.Skills.map((skill) => 
                        <div className="sm:w-[90%] p-1 px-2 border-2 border-[#e40e82] bg-[#311138] rounded-3xl" key={item.id}>
                          {skill}
                        </div>
                        )}
                    </div>
